...
public class SmsReceiveException extends SmsException {
    ...
    public SmsReceiveException(String message) {
        this(message, (Throwable) null);
    }

    public SmsReceiveException(Throwable cause) {
        this(null, cause);
    }

    public SmsReceiveException(String message, @Nullable Throwable cause) {
        super(message, cause);
        this.failedPhones = new LinkedHashMap();
    }

    public SmsReceiveException(@Nullable String message, @Nullable Throwable cause, Map<String, Exception> failedMessages) {
        super(message, cause);
    ...
    public SmsReceiveException(Map<String, Exception> failedMessages) {
